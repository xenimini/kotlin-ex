    ...
    addScene {
        ...
        addPanelSurface {
            ...
            Column {
                ...
                Text("HP: ${game.hp.use()}"){}
                Text("Отравдение: ${game.potionTicksLeft.use()}"){}
                Text("сила: ${game.attack.use()}"){}
            }
            Row{
            ...
            Row {
                ...
                Button ("Получить меч"){
                    modifier
                        ...
                        .onClick{
                            val idx = game.selectedSlot.value
                            val updated = putIntoSlot(game.hotbar.value, idx, SWORD, 6)
                            game.hotbar.value = updated
                        }
                }
            ...
            Row{
                ...
                Button("использовать меч"){
                    modifier.onClick{
                        game.attack.value += 10
                    }
                }
            }
